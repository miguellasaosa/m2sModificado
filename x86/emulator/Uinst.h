...
{
public:
		/*Modificaciones (nuevos campos)*/
	unsigned valor,valor2;
	int numBytes,numBytes2,flags;
...
/*
	void setValor(unsigned n){
		valor=n;
	}

	void setValor2(unsigned n){
		valor2=n;
	}
