...
{ \
	...
	if (wb) { \
		...
		newUinst(uinst, Uinst::DepEax, cin_dep, 0, Uinst::DepEax, \
				Uinst::DepZps, Uinst::DepCf, Uinst::DepOf,ax,2,flags); \
	} else { \
		newUinst(uinst, Uinst::DepEax, cin_dep, 0, Uinst::DepZps, \
				Uinst::DepCf, Uinst::DepOf, 0, -1, 0); \
	} \
	regs.setEflags(flags); \
}
...
{ \
	...
	if (wb) { \
		...
		newUinst(uinst, Uinst::DepEax, cin_dep, 0, Uinst::DepEax, \
				Uinst::DepZps, Uinst::DepCf, Uinst::DepOf,eax,4,flags); \
	} else { \
		newUinst(uinst, Uinst::DepEax, cin_dep, 0, Uinst::DepZps, \
				Uinst::DepCf, Uinst::DepOf, 0,-1,0); \
	} \
...
{ \
	...
	if (wb) { \
		...
		newUinst(uinst, Uinst::DepRm8, cin_dep, 0, Uinst::DepRm8, \
				Uinst::DepZps, Uinst::DepCf, Uinst::DepOf,rm8,1,flags); \
	} else { \
...
{ \
	...
	if (wb) { \
		...
		newUinst(uinst, Uinst::DepRm16, cin_dep, 0, Uinst::DepRm16, \
				Uinst::DepZps, Uinst::DepCf, Uinst::DepOf,rm16,2,flags); \
	} else { \
...
{ \
	...
	if (wb) { \
		...
		newUinst(uinst, Uinst::DepRm32, cin_dep, 0, Uinst::DepRm32, \
				Uinst::DepZps, Uinst::DepCf, Uinst::DepOf,rm32,4,flags); \
	} else { \
...
{ \
	...
	if (wb) { \
		...
		newUinst(uinst, Uinst::DepR8, Uinst::DepRm8, cin_dep, Uinst::DepR8, \
				Uinst::DepZps, Uinst::DepCf, Uinst::DepOf,r8,1,flags); \
	} else { \
...
{ \
	...
	if (wb) { \
		...
		newUinst(uinst, Uinst::DepR16, Uinst::DepRm16, cin_dep, Uinst::DepR16, \
				Uinst::DepZps, Uinst::DepCf, Uinst::DepOf,r16,2,flags); \
	} else { \
